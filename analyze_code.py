...
def analyzeCode(text_code = None):
    returnedJSON = {}
    ...
    if (text_code is not None):
        ...
        returnedJSON['v_g'] =               0 # 2.
        returnedJSON['ev_g'] =              0 # 3.
        returnedJSON['iv_g'] =              0 # 4.

        # print( rm.h_visit(text_code) )  # 1. Хольстееед
        returnedJSON['length'] =            0 # 5.
        returnedJSON['volume'] =            0 # 6.
        returnedJSON['calculated_length'] = 0 # 7.
        returnedJSON['difficulty'] =        0 # 8.
        returnedJSON['intelligence'] =      0 # 9. 1/difficulty
        returnedJSON['effort'] =            0 # 10.
        returnedJSON['bugs'] =              0 # 11.
        returnedJSON['time'] =              0 # 12.
        returnedJSON['h1'] =                0 # 17.
        returnedJSON['h2'] =                0 # 18.
        returnedJSON['N1'] =                0 # 19.
        returnedJSON['N2'] =                0 # 20.

        # print( rw.analyze(text_code) )                  # 2. Роу (строка)
        returnedJSON['LOC'] =               0 # 1.
        returnedJSON['SLOC'] =              0 # 13.
        returnedJSON['single_comments'] =   0 # 14.
        returnedJSON['blank'] =             0 # 15.
        returnedJSON['multi'] =             0 # 16.

        # ######### 4*. Количество брэнчЕй
        returnedJSON['count_branch'] =      0 # 21.
    print( returnedJSON )
